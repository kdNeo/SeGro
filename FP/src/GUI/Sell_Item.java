 ...
 * @author Intel
 */
public class Sell_Item extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tf_margin = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sell Items", javax.swing.border.TitledBorder.LEADING, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Century Gothic", 1, 14))); // NOI18N
        ...
        tf_margin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tf_marginKeyTyped(evt);
            }
        });
        jPanel1.add(tf_margin, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 131, -1));
    ...
    public void loadAllSelItems() {
        try (
                ResultSet rs = DB.search("select code,name from product where type='sell'");) {
    ...
    private void tf_marginKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_marginKeyTyped
        Helper.numericDataAdd(tf_margin, evt);
    }//GEN-LAST:event_tf_marginKeyTyped
    ...
    private void addSelectionToGrn() {
        ...
        String margin = tf_margin.getText();
        if (margin.isEmpty()) {
            tf_margin.grabFocus();
            return;
        }
        ...
        try (
            ...
            BigDecimal marg = new BigDecimal(margin);
            ...
            if (!discount.isEmpty()) {
                ...
                BigDecimal inter = buy.subtract(dis);
                tot = inter.multiply(new BigDecimal(qty));
                sell = inter.add(marg).setScale(2);
            } else {
                sell = buy.add(marg).setScale(2);
            ...
            v.add(marg.setScale(2).toString());
            v.add(sell.setScale(2).toString());
    ...
    private javax.swing.JTextField tf_margin;
